...
- **Namespace completeness.** AC-DL-2's list is necessarily incomplete at any moment — a deterministic floor, not a proof of absence. Pair with dependency review on every new addition. **[UNVERIFIED — completeness of any denylist namespace set]**
